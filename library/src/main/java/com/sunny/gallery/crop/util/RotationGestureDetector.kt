...
class RotationGestureDetector(private val mListener: OnRotationGestureListener?) {
    ...
    private val invalidPointerIndex = -1
    ...
    init {
        mPointerIndex1 = invalidPointerIndex
        mPointerIndex2 = invalidPointerIndex
    }
    ...
    fun onTouchEvent(event: MotionEvent): Boolean {
        when (event.actionMasked) {
            ...
            MotionEvent.ACTION_MOVE -> if (mPointerIndex1 != invalidPointerIndex && mPointerIndex2 != invalidPointerIndex && event.pointerCount > mPointerIndex2) {
            ...
            MotionEvent.ACTION_UP -> mPointerIndex1 = invalidPointerIndex
            MotionEvent.ACTION_POINTER_UP -> mPointerIndex2 = invalidPointerIndex
        }
        return true
    }
