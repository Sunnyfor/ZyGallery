...
class HorizontalProgressWheelView : View {
    ...
    init {
        ...
        mProgressLineWidth = context.resources.getDimensionPixelSize(com.sunny.zy.R.dimen.dp_2)
        mProgressLineHeight = context.resources.getDimensionPixelSize(com.sunny.zy.R.dimen.dp_20)
        mProgressLineMargin = context.resources.getDimensionPixelSize(com.sunny.zy.R.dimen.dp_10)
        ...
        mProgressLinePaint.color = ContextCompat.getColor(context, R.color.gallery_front)
        ...
        mProgressMiddleLinePaint.strokeWidth =
            context.resources.getDimensionPixelSize(com.sunny.zy.R.dimen.dp_4).toFloat()
    }
